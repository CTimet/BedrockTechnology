...
public abstract class BaseGui extends SlimefunItem implements InventoryBlock {
    public BaseGui(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
