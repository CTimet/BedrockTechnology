...
public abstract class OnlyGui extends SlimefunItem implements InventoryBlock {
    public OnlyGui(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
