...
public class BaseItemRegister {
    public static void register() {
        ...
        new SlimefunItem(
                ...
                BRecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] {
                        BItems.item(Material.DIAMOND_PICKAXE), SlimefunItems.PROGRAMMABLE_ANDROID_MINER, BItems.item(Material.DIAMOND_PICKAXE),
        ...
        new SlimefunItem(
                ...
                new ItemStack[]{
                        null,                       BItems.item(Material.IRON_BLOCK), null,
                        BItems.item(Material.IRON_BLOCK),  null,                      BItems.item(Material.IRON_BLOCK),
                        null,                       BItems.item(Material.IRON_BLOCK), null
                }
        ).register(BektMain.getInstance());
        new SlimefunItem(
